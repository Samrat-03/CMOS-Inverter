...
N 230 220 250 220 {
lab=GND}
C {devices/vsource.sym} 200 350 0 0 {name=VCC value=0 savecurrent=false}
...
.save all"}
C {devices/code_shown.sym} 350 280 0 0 {name=s3 only_toplevel=false value=".dc Vin 0 2.2 1m VCC 0.3 1.8 0.3
.save all
.end"}
